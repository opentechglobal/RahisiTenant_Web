...
import { PROOFS_FEATURE } from 'common/data/Landing';
...
const TrustedHistory = ({
  ...
  return (
    <TrustedWrapper id="features_section">
...
TrustedHistory.defaultProps = {
  ...
  title: {
    content: 'A collection of features that will make your life easier.',
  ...
  description: {
    content:
      'Easily manage your property with our integrated software that combines multiple programs into one robust system.',
    fontSize: '16px',
    fontWeight: '400',
    color: '#525f7f',
    lineHeight: '28px',
  ...
  sectionSubTitle: {
    content: 'All your software needs in one Application',
    as: 'span',
    textAlign: 'left',
