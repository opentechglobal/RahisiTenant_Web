...
import { TRANSACTIONS_FEATURE } from 'common/data/Landing';
...
const TransactionsHistory = ({
  ...
  return (
    <TransactionsWrapper id="portfolio_section">
      <Container>
        <Box className="row" {...row}>
          <Box className="colleft" {...col} style={{ flexDirection: 'column' }}>
            ...
            <FeatureBlock
              ...
              // button={<Button title="GET IN TOUCH" {...btnStyle} />}
            />
          </Box>
...
TransactionsHistory.defaultProps = {
  ...
  title: {
    content: 'Our Property Management System is built to cater to your needs.',
  ...
  description: {
    content:
      'You can trust us for any kind of property management services and some of the world class agencies have also trusted us.',
    fontSize: '16px',
    fontWeight: '400',
    color: '#525f7f',
    lineHeight: '28px',
